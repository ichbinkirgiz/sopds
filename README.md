...
2. Немного увеличил размер миниобложек. Клик по ней открывает полноразмерную обложку в ~~новой вкладке браузера~~ модальном окне.
...
4. Переделал онлайн читалку. Терерь можно полистать книгу в модальном окне, предже чем тащить её в свой E-book-reader.<br>
5. Добавил аннотацию книги.
