...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('filename', models.CharField(db_index=True, max_length=512)),
                ...
                ('docdate', models.CharField(db_index=True, max_length=32)),
                ('lang', models.CharField(max_length=16)),
                ('title', models.CharField(db_index=True, max_length=512)),
                ('search_title', models.CharField(db_index=True, default=None, max_length=512)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('readtime', models.DateTimeField(db_index=True, default=django.utils.timezone.now)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cat_name', models.CharField(db_index=True, max_length=190)),
                ('path', models.CharField(db_index=True, max_length=512)),
                ('cat_type', models.IntegerField(default=0)),
                ('cat_size', models.BigIntegerField(default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ser', models.CharField(db_index=True, max_length=150)),
                ('search_ser', models.CharField(db_index=True, default=None, max_length=150)),
                ('lang_code', models.IntegerField(db_index=True, default=9)),
            ],
        ),
        migrations.AddField(
